...
// Use this API to do reverse geocoding. The AJAX call
// will be done to a URL with this format:
// https://api.bigdatacloud.net/data/reverse-geocode-client?latitude=${lat}&longitude=${lng}`. Use the fetch API and
